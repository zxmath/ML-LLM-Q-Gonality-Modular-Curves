...
def main():
    print("Starting FT-Transformer 5-Fold Cross-Validation Experiment")
    print("=" * 60)
    ...
    for fold in range(5):
        ...
        test_file = os.path.join(data_dir, f"test_data.csv")
...
# Train the model using your current setup
        ...
        test_evaluation[fold] = {
            'r2': r2_test_ft,
            
            'accuracy': accuracy_test_ft,
            'rmse': rmse_test_ft
        }
        diff_evaluation[fold] = {
